...
public class ValidateSubstanceList extends TermServerReport implements ReportClass {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ValidateSubstanceList.class);
	...
	private void loadSubstanceList() throws TermServerScriptException {
		File inputFile = new File("G:\\My Drive\\005_Ad_hoc_queries\\045_SaudiArabia\\MOH Allergy Substance List Unicode.txt");
