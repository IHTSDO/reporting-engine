...
public abstract class TemplateReport extends TermServerReport {

	private static final Logger LOGGER = LoggerFactory.getLogger(TemplateReport.class);
	...
	private void validateTemplate(Template t) throws TermServerScriptException {
		...
		if (findConcepts(ecl, false, useLocalStoreIfSimple).isEmpty()) {
