...
public class AxiomUtils {
	...
	public static List<org.ihtsdo.termserver.scripting.domain.Relationship> toRelationships(Concept c, AxiomRepresentation axiom) throws TermServerScriptException {
