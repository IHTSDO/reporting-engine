...
public class ContainedInSubhierarchies extends TermServerReport {
	...
	public static void main(String[] args) throws TermServerScriptException, IOException, SnowOwlClientException {
		...
		try {
			...
			info("Failed to produce ContainedInSubhierarchyReport Report due to " + e.getMessage());
	...
	private void runContainedInSubhierarchyReport() throws TermServerScriptException {
		...
		info (df.format(notClinicalFindingPerc) + "% of starter set is not clinical finding");
		info ("Of the concepts that ARE clinical findings:");
		...
		info (df.format(containedPerc) + "% of starter set clinical findings are covered by QI subhierarchies");
		info (df.format(notContainedPerc) + "% of starter set clinical findings are not covered by QI subhierarchies");
