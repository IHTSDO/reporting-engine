...
public interface RF2Constants {
	...
	public enum ConceptType { PRODUCT_STRENGTH, MEDICINAL_ENTITY, MEDICINAL_FORM, MEDICINAL_PRODUCT, GROUPER, PRODUCT_ROLE, THERAPEUTIC_ROLE, VMPF, VCD, VMP, UNKNOWN, ANATOMY, CLINICAL_DRUG };
