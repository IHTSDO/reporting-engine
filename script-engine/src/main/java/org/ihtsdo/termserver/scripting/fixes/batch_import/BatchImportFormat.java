...
public class BatchImportFormat implements ScriptConstants {
	...
	protected static final Map<FIELD, Integer>SIRS_MAP = new HashMap<>();
	static {
	...
	protected static final Map<FIELD, Integer>ICD11_MAP = new HashMap<>();
	static {
		//Note that these are 0-based indexes
	...
	protected static final Map<FIELD, Integer>LOINC_MAP = new HashMap<>();
	static {
		SIRS_MAP.put(FIELD.ORIG_REF, 0);
		SIRS_MAP.put(FIELD.SCTID, 2);
		SIRS_MAP.put(FIELD.PARENT_1, 8);
