...
public class DrugTermGeneratorCD extends TermGenerator {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(DrugTermGeneratorCD.class);
	...
	public DrugTermGeneratorCD (TermServerScript parent) {
		this.parent = parent;
	...
	public DrugTermGeneratorCD includeUnitOfPresentation(Boolean state) {
	...
	public DrugTermGeneratorCD useEach(Boolean state) {
		useEach = state;
		return this;
	}
	...
	public DrugTermGeneratorCD specifyDenominator(Boolean state) {
