...
public class CreateConceptsDelta extends DeltaGenerator {
	...
	private final String[] fsns = new String[]{"NUVA code identifier (core metadata concept)", "Valence (disposition)"};
	private final String[] parents = new String[]{"900000000000453004 |Identifier scheme|", "726711005 |Disposition|"};
	...
	private void addRelationships(Concept c, String parentStr) throws TermServerScriptException {
		...
		r.setRelationshipId(relIdGenerator.getSCTID());
