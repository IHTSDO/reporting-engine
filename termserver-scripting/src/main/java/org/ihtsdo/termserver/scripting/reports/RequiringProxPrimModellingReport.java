...
public class RequiringProxPrimModellingReport extends TermServerScript{
	...
	public static void main(String[] args) throws TermServerScriptException, IOException, SnowOwlClientException {
		...
		try {
			...
			report.reportRequiringProxPrimModelling();
		} catch (Exception e) {
	...
	private void reportRequiringProxPrimModelling() throws TermServerScriptException {
		for (String hiearchySCTID : hierarchies) {
			...
			for (Concept thisConcept : allActiveFD) {
				...
				if (hasFDParent || noDifferentia || multipleParents) {
