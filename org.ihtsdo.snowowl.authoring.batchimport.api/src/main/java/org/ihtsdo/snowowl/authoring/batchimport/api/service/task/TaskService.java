...
import org.ihtsdo.snowowl.authoring.batchimport.api.pojo.task.TaskTransferRequest;
import org.ihtsdo.snowowl.authoring.batchimport.api.service.BranchService;
import org.ihtsdo.snowowl.authoring.batchimport.api.service.PathHelper;
import org.ihtsdo.snowowl.authoring.batchimport.api.service.util.TimerUtil;
import org.ihtsdo.snowowl.authoring.batchimport.api.pojo.task.AuthoringTaskUpdateRequest;
import org.ihtsdo.snowowl.authoring.batchimport.api.service.task.jira.ImpersonatingJiraClientFactory;
import org.ihtsdo.snowowl.authoring.batchimport.api.service.task.jira.JiraHelper;
...
public class TaskService {
	...
	public AuthoringTask updateTask(String projectKey, String taskKey, AuthoringTaskUpdateRequest taskUpdateRequest)
		...
		try {
			...
			final org.ihtsdo.snowowl.authoring.batchimport.api.pojo.task.User assignee = taskUpdateRequest.getAssignee();
			...
			final org.ihtsdo.snowowl.authoring.batchimport.api.pojo.task.User reviewer = taskUpdateRequest.getReviewer();
			if (reviewer != null) {
